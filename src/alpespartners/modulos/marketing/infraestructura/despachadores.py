...
from alpespartners.modulos.marketing.infraestructura.schema.v1.eventos import (
...
from alpespartners.modulos.marketing.infraestructura.schema.v1.comandos import (
